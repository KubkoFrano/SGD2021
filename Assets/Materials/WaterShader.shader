Shader "Roystan/Toon/Water Tut"
{
		...
		SubShader
	{
		...
		float2 distortSample = (tex2D(_SurfaceDistortion, i.distortUV).xy * _NoiseScale * 2 - 1) * _SurfaceDistortionAmount;
		...
		float2 noiseUV = float2((i.noiseUV.x * _NoiseScale + _Time.y * _SurfaceNoiseScroll.x) + distortSample.x,
		(i.noiseUV.y * _NoiseScale + _Time.y * _SurfaceNoiseScroll.y) + distortSample.y);
